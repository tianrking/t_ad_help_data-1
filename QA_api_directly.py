...
df_directly_QA=pd.read_csv("/home/tianrking/t_ad_help_data/data/QA_directly/腾讯广告帮助中心main.csv")

@app.post("/v1/QA/search/jzmh/directly/messagee")
async def create_item(item: Item_jzmh,request : Request):
    print(df_directly_QA)
